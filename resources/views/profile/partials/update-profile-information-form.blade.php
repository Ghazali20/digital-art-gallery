<section>
    ...
    {{-- PERBAIKAN FINAL: Menggunakan @method('patch') agar sinkron dengan routes/web.php Anda --}}
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div class="flex items-center gap-4">
            {{-- Tombol dengan desain monokrom Mentality --}}
            <x-primary-button class="bg-black hover:bg-gray-800 focus:bg-black active:bg-black">
                {{ __('Save') }}
            </x-primary-button>
